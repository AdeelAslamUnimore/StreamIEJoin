...
public class BPlusTree implements Serializable {
        ...
        public void insert(int key, int id) {
            ...
            if (null == this.root) {
                ...
                newNode.getKeys().add(new Key(key, id));
                this.root = newNode;
            ...
            // Case 2: Only one node that is not full
                ...
                insertWithinExternalNode(key, id, this.root);
            }
         ...
         */
        private void insertWithinExternalNode(int key, int id, Node node) {
