...
public class MutableBPlusTreeBoltAsynchronisisWindow extends BaseRichBolt {
    ...
    private int mergeIntervalCounterForStreamR;
    ...
    public MutableBPlusTreeBoltAsynchronisisWindow(String operator, String permutationStreamID, String offsetStreamID) {
