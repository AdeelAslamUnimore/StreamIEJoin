...
//                    }
    ...
    public void declareOutputFields(OutputFieldsDeclarer outputFieldsDeclarer) {
        ...
        outputFieldsDeclarer.declareStream(recordIEJoinStreamID, new Fields("ID", "KafkaTupleReadingTime", "KafkaTime", "Time", "Com_Time", "tupleCounter","taskId", "hostName","ThreadName","LinkedListIndex"));
