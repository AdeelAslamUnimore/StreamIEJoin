...
public class RecordMutablePart extends BaseRichBolt{
  ...
  private String leftPredicateSourceStreamID = null;
        ...
        public RecordMutablePart() {
            Map<String, Object> map = Configuration.configurationConstantForStreamIDs();
            this.leftPredicateSourceStreamID = (String) map.get("LeftPredicateSourceStreamIDHashSet");
            this.rightPredicateSourceStreamID = (String) map.get("RightPredicateSourceStreamIDHashSet");
