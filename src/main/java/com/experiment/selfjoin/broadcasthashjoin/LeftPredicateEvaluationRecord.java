...
public class LeftPredicateEvaluationRecord extends BaseRichBolt {
    private BufferedWriter bufferedWriter;

    @Override
    public void prepare(Map<String, Object> map, TopologyContext topologyContext, OutputCollector outputCollector) {
        try{
            this.bufferedWriter= new BufferedWriter(new FileWriter(new File("/home/adeel/Data/Results//LeftPredicateEvaluationRecord.csv")));
