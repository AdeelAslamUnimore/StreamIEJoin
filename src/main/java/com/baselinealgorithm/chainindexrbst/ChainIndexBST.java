...
public class ChainIndexBST {
    public static void main(String[] args) throws Exception {
        ...
        builder.setBolt(Constants.LEFT_PREDICATE_BPLUS_TREE_AND_RBS_BOLT, new LeftPredicateBoltBST()).fieldsGrouping("testBolt",(String) map.get("LeftSmallerPredicateTuple"), new Fields(Constants.TUPLE_ID)).
                fieldsGrouping("testBolt",(String) map.get("RightSmallerPredicateTuple"), new Fields(Constants.TUPLE_ID));

        builder.setBolt(Constants.RIGHT_PREDICATE_BPLUS_TREE_AND_RBST_BOLT, new RightPredicateBoltBST()).fieldsGrouping("testBolt",(String) map.get("LeftGreaterPredicateTuple"), new Fields(Constants.TUPLE_ID)).
